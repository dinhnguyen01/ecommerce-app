...
const SingleProduct = () => {
  ...
  return (
    <>
      ...
      <Container class1="single-product-wrapper home-wrapper-2 py-4">
        <div className="row">
          <div className="col-md-12">
            <div className="product-detail d-flex justify-content-center">
              ...
              <div className="col-md-6 ms-4">
                ...
                <h2 className="text-danger product-price fs-4">5,000,000 ₫</h2>
                <div
                  id="productCarousel"
              ...
              <div className="col-md-6 ms-4">
                ...
                <ul className="spec-list">
                  ...
                  <li>
                    Cổng kết nối: 2 x Thunderbolt 3 Jack tai nghe 3.5 mm MagSafe
                    3
                  </li>
                </ul>
          ...
          <div className="row">
            <div className="col-12">
              ...
              <p>
                ...
                điểm nổi bật và tính năng vượt trội giúp bạn giải quyết các nhu
                cầu hàng ngày. Bạn có thể xem thêm thông tin chi tiết và đánh
                giá của người dùng để hiểu rõ hơn về sản phẩm này.
              </p>
            </div>
          </div>
        </div>
